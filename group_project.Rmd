...
An example of project question based on this data could be: Do Hurricanes have an significant impact on the chemistry of streams?  The datasets to merge could be the [one] we used for Luquillo combined with other LTER sites, such as [Florida Coastal Everglades](https://lternet.edu/site/florida-coastal-everglades-lter/), or [USGS stream chemistry[(https://waterdata.usgs.gov/nwis)] data that are also frequently impacted by Hurricanes.


Actually, there was a recent LTER synthesis working group which look at patterns in stream chemistry: https://lternet.edu/working-groups/stream-energy-nutrient-cycling/ !
