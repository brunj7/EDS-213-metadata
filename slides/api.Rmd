...
XML provides the basic, common, and quite simple structure and syntax. It is the buildind block of `HTML`, `SVG` and `EML` are specific vocabularies of XML.
...
`httr` is an R package that let's you send requests to web services.  Let's try to use the GitHub API to list all my repositories
...
Developing and maintaining an API require resources and not all data provider can afford it!
